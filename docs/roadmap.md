...
The current 0.2 foundation separates Lean extraction, semantic interpretation, planning, rendering, and numerical exploration. It makes previously unplottable statements structurally inspectable and permits deeper inspection of definitions. It is not the completed universal visualizer.
...
3. **Witness strategies and families.** Represent a witness as a function of permitted earlier choices. Separate a proposed strategy, a sampled response, and a formally checked claim. Never use numerical success to silently discharge a universal quantifier.
